      ...
      <div class="col q-px-none">
        <div class="row q-pa-md back-separator">
          <div class="col" @click="$router.push('/scanner')">
            <img
              style="height: 12.44px; width: 18.67px"
              class="q-mr-xs"
              src="~/src/assets/back.png"
            />Back
          </div>
          <div class="col scan-top-txt text-right"></div>
        </div>
        <div class="row">
          <div
            class="col col-xs-12 col-sm-8 col-md-5 col-lg-5 col-xl-5 q-pa-sm"
            style="margin: auto"
          >
            <form @submit.prevent.stop="clickButton()">
              <p
                style="font-size: 20px"
                class="text-weight-bold text-center q-mt-lg q-mb-lg"
              >
                Check Member ID
              </p>
              <div class="col-inputs">
                <div style="display: inline-block">
                  <p class="q-mb-sm text-weight-bold text-left">
                  ...
                  <div
                    v-if="isEmptyInput == true"
                    class="notMatchText text-left"
                  >
                    Please provide input on required information.
                  </div>
                  <p
                    style="color: #00000073; font-size: 13px; margin-top: 4px"
                    class="q-mt-sm text-left text-weight-medium"
                  >
                    Enter 16 digit number
                  </p>
                  <div class="row q-mt-lg">
                    <div class="col" style="margin: auto">
                      <p v-if="notMatch" class="text-left notMatchText">
...
const clickButton = async () => {
  if (navigator.onLine == true) {
    ...
    method: 'GET',
    module: 'dcs',
    url: `/dcs-service/qrocr/verify-ocr?cardNumber=${memberID}`,
    })
...
onBeforeRouteLeave((to, from, next) => {
  document.getElementById("memberOne").value = null;
  document.getElementById("memberTwo").value = null;
  document.getElementById("memberThree").value = null;
  document.getElementById("memberFour").value = null;
  next();
});
</script>